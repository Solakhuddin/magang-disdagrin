...
if(@$_GET['id']==null){
	...
	$jKonten = 'Artikel';
	$stmt = mysqli_prepare($koneksi,"SELECT * FROM kontenweb WHERE KodeKonten = ? AND JenisKonten = ?");

	mysqli_stmt_bind_param($stmt, "ss", $decode, $jKonten);
  ...
  <?php 
	...
	//Tambah Data
		if(isset($_POST['Simpan'])){
			...
			mysqli_stmt_bind_param($stmt, "ssssss", $Kode, $TanggalTransaksi, $JenisKonten, $JudulKonten, $IsiKonten, $login_id);
	...
	//Edit Data	
		if(isset($_POST['SimpanEdit'])){
			...
			// Prepare the SQL statement
			$query = "UPDATE kontenweb SET IsiKonten=?, JudulKonten=?, TanggalKonten=? WHERE KodeKonten=? AND JenisKonten='Artikel'";

			$stmt = mysqli_prepare($koneksi, $query);

			mysqli_stmt_bind_param($stmt, "ssss", $IsiKonten, $JudulKonten, $TanggalTransaksi, $KodeKonten);
...
// Access $Dokumen for the fetched value
